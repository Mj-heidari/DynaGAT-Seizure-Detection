...
Publication figure and table generator for DynaGAT.
    ...
    python make_paper_figures.py                    # everything available
    python make_paper_figures.py --only causal_matrix
    python make_paper_figures.py --list
...
def write_figures_tex(made: List[str]) -> None:
    widths = {"fig_causal_matrix": 1.0, "fig_duration_vs_sensitivity": 1.0,
              ...
              "fig_convergence": 1.0}
    out = ["% Auto-generated by make_paper_figures.py",
